...
public class BatchesTest {
	...
	public void verifyStartDateSort() {
		...
		// WebElement element =
		// wait.until(ExpectedConditions.elementToBeClickable(batches.startDate));
		batches.batchesButton.click();
...

		{
			...
			try {
				...
				Assert.assertTrue(date1.after(date2)); // date1 is before date 2; date1 is first row
	...
	public void verifyStartDateArrowSort() {
		...
		// WebElement element =
		// wait.until(ExpectedConditions.elementToBeClickable(batches.startDateArrow));
	...
	public void verifyEndDateSort() {
		...
		// WebElement element =
		// wait.until(ExpectedConditions.elementToBeClickable(batches.endDate));
		batches.batchesButton.click();
	...
	public void verifyEndDateArrowSort() {
		...
		// WebElement element =
		// wait.until(ExpectedConditions.elementToBeClickable(batches.endDateArrow));
		batches.batchesButton.click();
...

		{
			...
			try {
				...
				// Assert.assertTrue(date1.compareTo(date2)<0); //date1 is before date 2; date1
				// is first row
